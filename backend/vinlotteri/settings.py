"""
Django settings for vinlotteri project.
"""
...
WSGI_APPLICATION = 'vinlotteri.wsgi.application'

# Database - SQLite with configurable path for Docker volume
